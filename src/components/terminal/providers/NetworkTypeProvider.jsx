...
export const NETWORK_CONFIGS = {
  [NETWORK_TYPES.MAIN_NET]: {
    ...
    graphqlEndpoint: import.meta.env.VITE_GRAPHQL_ENDPOINT || 'https://api.okinoko.io/api/v1/graphql',
    hasuraHttp: import.meta.env.VITE_HASURA_HTTP || 'https://api.okinoko.io/hasura/v1/graphql',
    hasuraWs: import.meta.env.VITE_HASURA_WS || 'wss://api.okinoko.io/hasura/v1/graphql',
    blocksBackend: import.meta.env.VITE_BLOCKS_BACKEND || 'https://vsc.techcoderx.com/be-api/v1',
    explorerUrl: 'https://vsc.techcoderx.com',
    contractDeployUrl: import.meta.env.VITE_CONTRACT_DEPLOY_URL || 'https://deploy.okinoko.io',
  ...
  [NETWORK_TYPES.TEST_NET]: {
    ...
    graphqlEndpoint: import.meta.env.VITE_TESTNET_GRAPHQL_ENDPOINT || 'https://api-testnet.okinoko.io/api/v1/graphql',
    hasuraHttp: import.meta.env.VITE_TESTNET_HASURA_HTTP || 'https://api-testnet.okinoko.io/hasura/v1/graphql',
    hasuraWs: import.meta.env.VITE_TESTNET_HASURA_WS || 'wss://api-testnet.okinoko.io/hasura/v1/graphql',
